...
func TestClassify(t *testing.T) {
	...
	tests := []struct {
		...
		{
			// The aibridge budget rejection is a 403 with a text/plain
			// body; the SDK error message reduces to a bare status line,
			// so the body is the only usage-limit signal.
